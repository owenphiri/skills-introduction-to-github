...
module.exports = {
  ...
  dbFile: process.env.DE_DB || path.join(__dirname, '..', 'data', 'daily-essential.db'),

  serviceName: process.env.SERVICE_NAME || 'Daily Essential',
  ...
  messaging: {
    ...
    senderId: process.env.SMS_SENDER_ID || 'DAILYESS',
