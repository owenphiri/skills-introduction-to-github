  ...
  return (
    <div className="vx-re-card">
      ...
      <div className="vx-re-body">
        ...
        <Link to="/signup" className="vx-btn-primary vx-btn-sm" style={{ width: "100%" }}>
          Invest from {money(p.min_invest_usd)} →
        </Link>
      </div>
    </div>
  );
    ...
    <div className="vx-page">
      ...
      <section className="vx-re-hero">
        <div className="vx-container vx-re-hero-in">
          <span className="vx-eyebrow">VoltexAI Real Estate</span>
      ...
      <main className="vx-container">
        ...
        <section className="vx-cta-band">
          <h2>Build a portfolio that pays you rent.</h2>
          <p>Diversify your trading gains into real, income-producing property — from $50.</p>
          <div className="vx-hero-cta">
            <Link to="/signup" className="vx-btn-primary vx-btn-lg">Create a free account</Link>
